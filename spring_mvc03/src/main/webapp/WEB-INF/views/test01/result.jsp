...
<body>
	...
	<h2>이미지 보기</h2>
	<!-- 이미지는 무조건 resources 폴더에 넣기 -->
	<img src="/resources/images/Aston_Martin-One-77.jpg" style="width: 100px;"><br>
	권장: <img src="resources/images/Aston_Martin-One-77.jpg" style="width: 100px;"><br>
	<img src='<c:url value= "/resources/images/Aston_Martin-One-77.jpg"/>' style="width: 100px;"><br>
	권장: <img src='<c:url value= "resources/images/Aston_Martin-One-77.jpg"/>' style="width: 100px;"><br>
	
	<hr>
	<!-- 이미지 업로드: cos 라이브러리 사용(MultipartRequest), spring에서 자체 지원 -->
