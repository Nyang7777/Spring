...
<body>
	...
	var iwContent = '<div style="padding:5px;">Hello World! <br><a href="http://ictedu.co.kr">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
